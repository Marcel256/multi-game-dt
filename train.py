...
def train(cfg: DictConfig):
    ...
    scheduler = optim.lr_scheduler.LambdaLR(optimizer, lr_lambda=lambda step: lr_decay(step, cfg.train.warmup_steps,  cfg.train.scheduler_steps,  cfg.train.min_lr_factor))
    model_version = 1
